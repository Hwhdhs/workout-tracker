...
const PLAN = {
  ...
  "Pull 1": { day:"Tuesday", exercises: [
    { id:"pl1_1", name:"Lat Pulldown (Close/Neutral)", target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",     type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/results?search_query=lat+pulldown+behind+back",      poRef:"Lat Pulldown (V-bar)",                poRefDay:"Pull 1" },
  ...
  "Pull 2": { day:"Friday", exercises: [
    { id:"pl2_1", name:"Lat Pulldown (Wide Grip)",     target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",     type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/results?search_query=lat+pulldown+behind+back+wide+grip",      poRef:"Fixed Pulldown",                      poRefDay:"Pull 2" },
...
const mansoorPlan = {
  ...
  "Pull 1": { exercises: [
    { id:"m_pl1_1", name:"Lat Pulldown (V-bar)",       target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",    type:"compound",  sets:4, defaultReps:"12", video:"https://www.youtube.com/results?search_query=lat+pulldown+behind+back" },
  ...
  "Pull 2": { exercises: [
    { id:"m_pl2_1", name:"Fixed Pulldown",               target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",  type:"compound",  sets:3, defaultReps:"15", video:"https://www.youtube.com/results?search_query=lat+pulldown+behind+back+women" },
...
const pariPlan = {
  ...
  "Session B": { focus:"Upper Body + Core", description:"Back · Chest · Shoulders · Arms · Core", exercises: [
    { id:"b_1", name:"Lat Pulldown",        target:"BACK WIDTH",      secondary:"Biceps, Rear Delts", type:"compound",  sets:3, defaultReps:"12-15", tip:"Pull bar to upper chest, lean back slightly. Control the weight on the way up — don't let it snap.", video:"https://www.youtube.com/results?search_query=lat+pulldown+behind+back+women" },
