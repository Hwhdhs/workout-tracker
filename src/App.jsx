...
const PARI_REST_DAY_PLAN = [
  ...
  { label:"Plank",                         detail:"3 sets · 30-60 secs",                   video:"https://www.youtube.com/shorts/Pkp3SOvipZ0" },
  { label:"Leg Raises",                    detail:"3 sets · 15 reps",                      video:"https://www.youtube.com/shorts/6cKTtcWxvQo" },
  { label:"Russian Twist",                 detail:"3 sets · 20 reps",                      video:"https://www.youtube.com/shorts/hLAZ-IgVXPw" },
...
const PLAN = {
  "Push 1": { day:"Monday", exercises: [
    ...
    { id:"p1_9", name:"Hip Abductor",                  target:"OUTER THIGH",                                            type:"isolation", sets:3, defaultReps:"15",    video:"https://www.youtube.com/shorts/uwKOs7z3O3g",         poRef:"Hip Abductor",                        poRefDay:"Push 1" },
  ...
  "Pull 1": { day:"Tuesday", exercises: [
    { id:"pl1_1", name:"Lat Pulldown (Close/Neutral)", target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",     type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/watch?v=RXMe40v6kso",      poRef:"Lat Pulldown (V-bar)",                poRefDay:"Pull 1" },
    { id:"pl1_2", name:"Row (Close/Neutral Grip)",     target:"MID BACK",            secondary:"Biceps, Rear Delts",     type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/shorts/I3Ia2y_Bh90",             poRef:"Seated Cable Row",                    poRefDay:"Pull 1" },
    ...
    { id:"pl1_8", name:"Romanian Deadlift",            target:"HAMSTRINGS & GLUTES", secondary:"Lower Back, Calves",    type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/shorts/CBOhr6H7BEY" },
    { id:"pl1_9", name:"Hip Adductor",                 target:"INNER THIGH",                                            type:"isolation", sets:3, defaultReps:"15",    video:"https://www.youtube.com/watch?v=e9AqTFMmP18",         poDefault:30 },
  ...
  "Push 2": { day:"Thursday", exercises: [
    ...
    { id:"p2_4", name:"Cable Lateral Raise",           target:"SIDE DELTS",                                             type:"isolation", sets:3, defaultReps:"12-15", video:"https://www.youtube.com/shorts/lK-Jupl2ciQ",           poRef:"Cable Lateral Raise",                 poRefDay:"Push 2" },
    ...
    { id:"p2_9", name:"Glute Kickback",                target:"GLUTES",                                                 type:"isolation", sets:3, defaultReps:"15",    video:"https://www.youtube.com/shorts/n-cgsNePyFo",               poRef:"Gluteus Standing Machine",            poRefDay:"Pull 1" },
    { id:"p2_f", name:"Seated Calf Raise",             target:"CALVES",                                                 type:"finisher",  sets:3, defaultReps:"15-20", video:"https://www.youtube.com/shorts/2UWMiKqwKUE" },
  ]},
  "Pull 2": { day:"Friday", exercises: [
    { id:"pl2_1", name:"Lat Pulldown (Wide Grip)",     target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",     type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/watch?v=RXMe40v6kso",      poRef:"Fixed Pulldown",                      poRefDay:"Pull 2" },
    ...
    { id:"pl2_8", name:"Leg Press",                    target:"QUADS & GLUTES",      secondary:"Hamstrings, Calves",     type:"compound",  sets:4, defaultReps:"8-12",  video:"https://www.youtube.com/shorts/KwDFg-BuqlE",                    poRef:"Leg Press",                           poRefDay:"Push 2" },
...
const mansoorPlan = {
  "Push 1": { exercises: [
    ...
    { id:"m_p1_8", name:"Hip Abductor",                        target:"OUTER THIGH",                                         type:"isolation", sets:3, defaultReps:"15",    video:"https://www.youtube.com/shorts/uwKOs7z3O3g" },
  ...
  "Pull 1": { exercises: [
    { id:"m_pl1_1", name:"Lat Pulldown (V-bar)",       target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",    type:"compound",  sets:4, defaultReps:"12", video:"https://www.youtube.com/watch?v=RXMe40v6kso" },
    { id:"m_pl1_2", name:"Seated Cable Row",            target:"MID BACK",            secondary:"Biceps, Rear Delts",    type:"compound",  sets:3, defaultReps:"12", video:"https://www.youtube.com/shorts/I3Ia2y_Bh90" },
    ...
    { id:"m_pl1_7", name:"Romanian Deadlift",           target:"HAMSTRINGS",          secondary:"Glutes, Lower Back",   type:"compound",  sets:3, defaultReps:"12", video:"https://www.youtube.com/shorts/CBOhr6H7BEY" },
  ...
  "Push 2": { exercises: [
    ...
    { id:"m_p2_3", name:"Cable Lateral Raise",                   target:"SIDE DELTS",                                     type:"isolation", sets:3, defaultReps:"15", video:"https://www.youtube.com/shorts/lK-Jupl2ciQ" },
    ...
    { id:"m_p2_5", name:"Rope Pushdown",                         target:"TRICEPS",                                        type:"isolation", sets:3, defaultReps:"15", video:"https://www.youtube.com/shorts/4NWWB0f0vzQ" },
    ...
    { id:"m_p2_8", name:"Leg Press",                             target:"QUADS & GLUTES", secondary:"Hamstrings, Calves", type:"compound",  sets:3, defaultReps:"12", video:"https://www.youtube.com/shorts/KwDFg-BuqlE" },
  ]},
  "Pull 2": { exercises: [
    { id:"m_pl2_1", name:"Fixed Pulldown",               target:"LATS WIDTH",          secondary:"Biceps, Rear Delts",  type:"compound",  sets:3, defaultReps:"15", video:"https://www.youtube.com/watch?v=RXMe40v6kso" },
